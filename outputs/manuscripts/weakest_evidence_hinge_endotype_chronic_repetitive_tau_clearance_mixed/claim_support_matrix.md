...
- **Phase:** phase6
- **Claim:** A chronic repetitive tau/clearance endotype may separate better by AQP4 or DTI-ALPS plus tau variants than by inflammation markers alone.
- **Support status:** provisional
- **Allowed language:** Use cautious, hypothesis-oriented wording and explicitly note boundedness.
- **Artifact refs:** phase6:weakest_evidence_hinge--endotype--chronic_repetitive_tau_clearance_mixed
- **Support PMIDs:** 41508043, 41612558, 41627284, 41700070, 41179995, 41039850, 41342721, 41707558
- **Reference details:**
  ...
  - Jansson D, Shofer J, Colasurdo E, et al. Alterations in CSF Amyloid-β and Tau Biomarkers in Former College and Professional American Football Players: Findings from the DIAGNOSE CTE Research Project. J Neurotrauma. Epub ahead of print 2026 Jan 29. DOI: 10.1177/08977151251390520.
  - Rodriguez RD, Nowinski C, Suemoto CK, et al. Clinicopathological study of chronic traumatic encephalopathy pathology in a population-based cohort. J Neuropathol Exp Neurol. Epub ahead of print 2026 Feb 2. DOI: 10.1093/jnen/nlaf150.
...
- **Phase:** phase1
- **Claim:** Tau accumulation, neurofibrillary pathology, and proteinopathy-linked degeneration across the TBI timeline.
...
- **Support PMIDs:** 41651695, 41508043, 41723222, 41665901, 41853047, 41496386, 41683989, 41179995, 41809435, 41953056
- **Reference details:**
...
- **Phase:** phase1
- **Claim:** AQP4 polarization, glymphatic flow, and astroglial clearance disruption across the TBI timeline.
- **Support status:** longitudinally_seeded
- **Allowed language:** Use cautious wording and avoid definitive causal or clinical claims.
- **Artifact refs:** phase1:glymphatic_astroglial_clearance_failure
- **Support PMIDs:** 41179995, 41039850, 41648326, 41968392, 41960329, 41700070, 41824127, 41153827, 41795770, 41827388
- **Reference details:**
  - Miettinen P, Utz B, Bañuelos-Cabrera I, et al. Glymphatic system and mild traumatic brain injury: a mini review. Front Neurosci 2025; 19: 1705690.
  - Zhao R, Dong S, Wu D, et al. A Drug Delivery to Improve Prognosis of Traumatic Brain Injury Mice Through Mouse-Derived Nerve Growth Factor Coated by a Nanoparticle. CNS Neurosci Ther 2025; 31: e70603.
...
- **Phase:** phase1
- **Claim:** Innate immune activation, cytokine signaling, and microglial state transitions following TBI.
- **Support status:** longitudinally_seeded
- **Allowed language:** Use cautious wording and avoid definitive causal or clinical claims.
- **Artifact refs:** phase1:neuroinflammation_microglial_state_change
- **Support PMIDs:** 41157272, 41103638, 41926211, 41663365, 41734021, 41752185, 41756234, 41756282, 41824127, 41926540
- **Reference details:**
...
- **Phase:** phase2
- **Claim:** Current TBI evidence supports a transition in which glymphatic failure contributes to tau or broader pathogenic protein accumulation.
...
- **Artifact refs:** phase2:glymphatic_failure_to_tau_protein_accumulation
- **Support PMIDs:** 41179995, 41700070, 41747594
- **Reference details:**
  - Miettinen P, Utz B, Bañuelos-Cabrera I, et al. Glymphatic system and mild traumatic brain injury: a mini review. Front Neurosci 2025; 19: 1705690.
  - Miyata M. [MRI-Based Insights into the Connection Between Traumatic Brain Injury, Glymphatic Dysfunction, and Neurodegenerative Disease]. Brain Nerve 2026; 78: 159-167.
  - PMID:41747594
...
- **Phase:** phase2
- **Claim:** Current TBI evidence suggests that sustained neuroinflammation and microglial state change can amplify tau pathology and broader proteinopathy progression.
- **Support status:** provisional
- **Allowed language:** Use cautious, hypothesis-oriented wording and explicitly note boundedness.
- **Artifact refs:** phase2:neuroinflammation_to_tau_proteinopathy_progression
- **Support PMIDs:** 41683989, 41809632
- **Reference details:**
  - Katramadou A, Bender ES and Kanakis D. From Traumatic Brain Injury to Alzheimer's Disease: Multilevel Biomechanical, Neurovascular, and Molecular Mechanisms with Emerging Therapeutic Directions. Int J Mol Sci 2026; 27. DOI: 10.3390/ijms27031570.
  - Mazurek CY, Kaniuk JK and Ahuja CS. Mesenchymal stem cells and the central nervous system: historical perspectives and future directions. Front Mol Neurosci 2026; 19: 1742864.
...
- **Phase:** phase3
- **Claim:** Tauopathy progression is one of the clearest bridges from repeated injury biology into chronic neurodegenerative trajectory risk.
- **Support status:** supported
- **Allowed language:** Use affirmative language for the mechanism or pattern, while staying within the current artifact scope.
- **Artifact refs:** phase3:tauopathy_progression
- **Support PMIDs:** 41179995, 41328339, 41496386, 41594797, 41651695, 41665901, 41683989, 41700070
- **Reference details:**
  - Miettinen P, Utz B, Bañuelos-Cabrera I, et al. Glymphatic system and mild traumatic brain injury: a mini review. Front Neurosci 2025; 19: 1705690.
  ...
  - Mononen M, Mohammadian M, Hossain I, et al. Association of acute blood biomarkers with diffusion tensor imaging and outcome in patients with traumatic brain injury presenting with GCS of 13-15. Neuroimage Clin 2026; 49: 103934.
  - Arachchi S, Daly E, Dwivedi A, et al. Sex Differences in Severity and Recovery Following Mild Traumatic Brain Injury: A Systematic Review. Brain Sci 2026; 16. DOI: 10.3390/brainsci16010077.
  - Melchior B, Browning M, McCartan R, et al. Targeting dual specificity tyrosine-phosphorylation-regulated kinase 1A mitigates tauopathy and enhances recovery after repetitive head injury. Neurotherapeutics 2026; 23: e00843.
  - Halbgebauer R, Gonzalez-Ortiz F, Mayer B, et al. Blood-Based Analysis of Different Tau Variants in Patients With Multiple Traumatic Injuries. JAMA Netw Open 2026; 9: e2558573.
  - Katramadou A, Bender ES and Kanakis D. From Traumatic Brain Injury to Alzheimer's Disease: Multilevel Biomechanical, Neurovascular, and Molecular Mechanisms with Emerging Therapeutic Directions. Int J Mol Sci 2026; 27. DOI: 10.3390/ijms27031570.
  - Miyata M. [MRI-Based Insights into the Connection Between Traumatic Brain Injury, Glymphatic Dysfunction, and Neurodegenerative Disease]. Brain Nerve 2026; 78: 159-167.
...
- **Phase:** phase3
- **Claim:** Cognitive decline is the downstream phenotype that makes the rest of the process engine clinically meaningful rather than merely mechanistic.
- **Support status:** provisional
- **Allowed language:** Use cautious, hypothesis-oriented wording and explicitly note boundedness.
...
- **Contradictions:** After adjusting for pre-injury baseline differences, mTBI did *not* decrease neurocognitive outcomes compared to controls within a year post-injury.
...
- **Phase:** phase5
- **Claim:** This is the strongest current packet for testing whether repetitive-impact cohorts need a clearance-first or tau-first translational logic instead of a generic inflammatory one.
- **Support status:** bounded
