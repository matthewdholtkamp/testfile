...
- **Task ID:** strengthen_translational_packet
- **Status:** running
- **Critical:** yes
- **Rationale:** The linked translational packet is still bounded, which caps manuscript confidence.
- **Success signal:** Linked Phase 4 packet becomes usable/actionable or accumulates stronger compound/trial/readout support.
- **Executor note:** Translational packet remains bounded around DYRK1A; strengthening brief updated.

## Translational packet status

- Primary target: DYRK1A
- Expected readouts: P Tau / phospho Tau burden, Circulating tau variants, Glial amplification, Chronic functional recovery
- Best next experiment: Extend the DYRK1A packet beyond phospho-tau alone by pairing tissue tau suppression with circulating tau variants and chronic function.
- Why primary now: DYRK1A is the strongest direct perturbation anchor surfaced in the current repo for this lane because the corpus already includes DYRK1A inhibition with SM07883 in a chronic repetitive head-injury model.
