...
- Phase 3 burden to carry in the narrative: Microglial Chronic Activation, Neurovascular Uncoupling.
- Endotype context to carry in the narrative: Acute Mild Biomarker / Imaging Bridge, Acute Severe Vascular-Dominant, Acute Blast Vascular / Inflammatory Mixed, Subacute Repetitive Inflammatory-Dominant.
...
- Allowed wording: Use affirmative language for the mechanism or pattern, while staying within the current artifact scope.
- Support PMIDs: 41663365, 41673382, 41642456, 41649131, 41954515, 41039850, 41934291, 41465583, 41725719, 41153827
