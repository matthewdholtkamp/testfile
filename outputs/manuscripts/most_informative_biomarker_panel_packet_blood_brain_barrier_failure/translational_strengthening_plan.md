...
- **Executor note:** Translational packet remains bounded around OCLN; strengthening brief updated.
...
- Best next experiment: Run an acute-to-subacute BBB repair packet around OCLN with Evans blue or gadolinium leakage, CLDN5/OCLN/TJP1 restoration, and a downstream inflammatory spillover panel.
- Why primary now: OCLN is the most evidence-dense tight-junction repair target in the current TBI corpus and best fits a barrier-module perturbation frame.
