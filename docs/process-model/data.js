window.CAUSAL_TRANSITION_DATA = {
  "metadata": {
    ...
    "process_json": "reports/process_lanes/process_lane_index_2026-03-28_145926.json",
    "synthesis_csv": "reports/mechanistic_synthesis/mechanistic_synthesis_blocks_2026-03-28_130716.csv"
  },
  "summary": {
    "transition_count": 6,
  ...
  "rows": [
    ...
    },
    {
      ...
      "observed_time_buckets": "subacute; chronic",
      "paper_count": 6,
      "direct_claim_count": 4,
      "direct_edge_count": 3,
      "causal_edge_count": 1,
      "synthesis_support_count": 0,
      "anchor_pmids": "41496386; 41739474; 41747594; 41508043; 41683989; 41853047",
      ...
      "biomarker_cues": "tau (11) || Tau (2) || nfl (2) || rd (1) || RD (1)",
      "contradiction_notes": "",
      "evidence_gaps": "Transition still needs denser direct support before it should be treated as hardened. || Some supporting rows are abstract-only and should be weighted cautiously. || Downstream lane is still seeded/provisional, so this transition should remain bounded. || Upstream lane still needs stronger longitudinal support.",
