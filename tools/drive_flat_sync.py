...
DEFAULT_PROJECT_LONGEVITY_FOLDER_ID = "17AcLt1OsQ2nV0mHGy0QRYL--eiFxc6wy"
...
def resolve_drive_root_id() -> str:
    root_id = (
        ...
        or os.environ.get("DRIVE_ROOT_FOLDER_ID")
        or os.environ.get("PROJECT_LONGEVITY_FOLDER_ID")
        or DEFAULT_PROJECT_LONGEVITY_FOLDER_ID
    )
    if not root_id:
        raise RuntimeError(
            "DRIVE_FOLDER_ID or DRIVE_ROOT_FOLDER_ID is required (or set PROJECT_LONGEVITY_FOLDER_ID)"
        )
    return root_id
