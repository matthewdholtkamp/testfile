...
- Open with the current thesis: Track NLRP3, IL-1beta, IL-6, TNF-alpha to test whether NLRP3 is moving the expected lane biology.
- Establish the lead mechanism lane(s): Neuroinflammation Microglial State Change
- Set up the directional bridge(s): BBB Permeability Increase To Peripheral Immune Infiltration, Mitochondrial ROS To Inflammasome Activation, Neuroinflammation To Tau Proteinopathy Progression

### 2. Results / Evidence Synthesis

#### Candidate manuscript thesis

- Claim to carry: Track NLRP3, IL-1beta, IL-6, TNF-alpha to test whether NLRP3 is moving the expected lane biology.
- Allowed wording: Use affirmative language for the mechanism or pattern, while staying within the current artifact scope.
- Support anchors: 41157272, 41103638, 41663365, 41734021, 41752185, 41756282, 41824127, 41612383, 41803087, 41511466, 41480492, 41683989, 41709060, 41712436, 41726892, 41737534, 41769894, 41803953, 41622481, 41659975
...
- Claim to carry: Current TBI evidence supports a directional transition in which BBB permeability increase facilitates peripheral immune infiltration.
- Allowed wording: Use affirmative language for the mechanism or pattern, while staying within the current artifact scope.
- Support anchors: 41709060, 41740873, 41683989

#### Mitochondrial ROS -> inflammasome activation

- Claim to carry: Current TBI evidence suggests that mitochondrial ROS or related mitochondrial stress signals amplify inflammasome activation.
- Allowed wording: Use cautious, hypothesis-oriented wording and explicitly note boundedness.
- Support anchors: 41480492, 41103638, 41709060
...
- Claim to carry: Persistent metabolic dysfunction is where intracellular stress may become self-sustaining instead of resolving after the acute phase.
- Allowed wording: Use cautious, hypothesis-oriented wording and explicitly note boundedness.
- Support anchors: 41069428, 41103638, 41110648, 41129987, 41153827, 41157305, 41175081, 41179995
...
- Claim to carry: This is the best current packet for distinguishing repetitive-TBI cohorts that may respond to inflammasome or glial-state perturbation before chronic tau biology hardens.
- Allowed wording: Use affirmative language for the mechanism or pattern, while staying within the current artifact scope.
- Support anchors: 41173520, 41446731, 41740873, 41740080, 41847037, 41508043, 41709584
...
- Keep the top blocker explicit: Study found no significant correlation, contradicting the hypothesis of cumulative damage.
